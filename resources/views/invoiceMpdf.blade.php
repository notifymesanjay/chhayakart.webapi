                ...
                <table class="table-condensed table-bordered product-table"  width="100%">
                    <thead>
                        <tr>
                            ...
                            <th align="center" width="10%">Discounted Price</th>
                    ...
                    @foreach($order_items as $index => $item)
                        <tr>
                            ...
                            <td align="right">{{ $item->discounted_price }}</td>
                    ...
                    <td width="50%" style="text-align: right;">
                        <table class="product-table">
                            <tbody>
                                ...
                                <tr>
                                    <td align="left">GST {{ $currency }} ({{$order->tax_percentage}}%)</td>
                                    <th align="right">{{ $order->tax_amount }}</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th align="left" style="padding: 8px; background-color: #37a279; color: white;">Final Total - {{ $currency }} (incl. Delivery Chrg.+ GST)</th>
