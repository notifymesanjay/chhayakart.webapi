        ...
        <form ref="my-form" @submit.prevent="saveRecord">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type='password' id='password' v-model="system_user.password" class='form-control' placeholder='Password' :required="!system_user.id ? true : false" />
                </div>
                <div class="form-group">
                    <label for='confirm_password'>Confirm Password</label>
                    <input type='password' id='confirm_password' v-model="system_user.confirm_password" class='form-control' placeholder='Confirm Password' :required="!system_user.id ? true : false" />
                </div>
