...
<!--                    <input type="file" name="slider_image" v-on:change="handleFileUpload" ref="file_image" class="file-input" :required="!id">-->
                    <input type="file" name="slider_image" v-on:change="handleFileUpload" ref="file_image" class="file-input">
