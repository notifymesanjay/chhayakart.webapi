            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Media Upload Form</h4>
                    </div>
                    <div class="card-body">
                        <b-row>
                            <div class="col-md-12">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    >
                                        <div class="dropzone-custom-content">
                                            <h3 class="dropzone-custom-title"><i class="fa fa-upload"></i> Drag and drop
                                                to upload image!</h3>
                                            <div class="subtitle">...or click to select a image from your device</div>
                                        </div>
                                    </vue-dropzone>
                        ...
                        <b-row class="mb-2">
                            <h4 class="card-title mt-3">Media List</h4>
    ...
    data: function () {
        return {
            ...
            fields: [
                ...
                {key: 'extension', label: 'Extension', sortable: true, class: 'text-center'},
                {key: 'type', label: 'Type', sortable: true, class: 'text-center'},
                {key: 'sub_directory', label: 'Sub Directory', sortable: true, class: 'text-center'},
