                        ...
                        <div class="card-header">
                            ...
                            <span class="pull-right">
                                <template v-if="$roleSeller == login_user.role.name">
                                     <router-link to="/seller/manage_products/create" class="btn btn-primary" v-b-tooltip.hover title="Add Product">Add Product</router-link>
                                </template>
                                <template v-else>
                                    <router-link to="/manage_products/create" class="btn btn-primary" v-b-tooltip.hover title="Add Product">Add Product</router-link>
                                </template>
                            </span>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-3">
                                    <b-dropdown size="sm" dropright text="Actions" split-variant="outline-primary"
                                        ...
                                        <b-dropdown-item href="javascript:void(0);" @click="multipleDelete"><span
                                            class="text-danger" style="font-weight: bold;"><i class="fa fa-trash"></i> Delete Selected Products</span>
                                        </b-dropdown-item>
                                    </b-dropdown>
                                </div>
                            </div>
                            <b-row class="mb-2">
                                <b-col md="2">
                                    <h6 class="box-title">Filter by Products Category</h6>
                                    <form method="post">
                                ...
                                <b-col md="2">
                                    <h6 class="box-title">Filter Products by Status </h6>
                                ...
                                <template v-else>
                                    <b-col md="3">
                                        <h6 class="box-title">Filter Products by Seller </h6>
    ...
    data: function () {
        return {
            ...
            fields: [
                ...
                {key: 'product_variant_id', label: 'ID', visible: false, sortable: true, sortDirection: 'desc'},
                {key: 'product_id', label: 'Product ID', visible: false, sortable: true, sortDirection: 'desc'},
                {key: 'tax_id', label: 'Tax ID', visible: false, sortable: true, class: 'text-center'},
                {key: 'seller_name', label: 'Seller Name', visible: true, class: 'text-center', sortable: true},
                {key: 'name', label: 'Name', visible: true, sortable: true, class: 'text-center'},
                {key: 'image', label: 'Image', visible: true, class: 'text-center'},
                {key: 'price', label: 'Price', visible: true, class: 'text-center', sortable: true},
                {key: 'discounted_price', label: 'D.Price', visible: true, class: 'text-center', sortable: true},
                {key: 'measurement', label: 'Measurement', visible: true, class: 'text-center', sortable: true},
                {key: 'stock', label: 'Stock', visible: true, class: 'text-center', sortable: true},
                {key: 'status', label: 'Availability', visible: true, class: 'text-center', sortable: true},
                {key: 'indicator', label: 'Indicator', visible: true, class: 'text-center', sortable: true},
                {key: 'is_approved', label: 'Is Approved?', visible: true, class: 'text-center', sortable: true},
                {key: 'return_status', label: 'Return', visible: true, class: 'text-center', sortable: true},
                {key: 'cancelable_status', label: 'Cancellation', visible: true, class: 'text-center', sortable: true},
                {key: 'till_status', label: 'Till Status', visible: true, class: 'text-center', sortable: true},
