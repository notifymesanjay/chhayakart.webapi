        ...
        <form ref="my-form" @submit.prevent="saveRecord">
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="category_image" v-on:change="handleFileUpload" ref="file_image" required v-if="!id">
                        <input type="file" name="category_image" v-on:change="handleFileUpload" ref="file_image" v-if="id">
