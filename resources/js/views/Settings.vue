                            ...
                            <form @submit.prevent="saveMailSetting">
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3>Order Mail Settings</h3>
                                                <div class="mt-5">
                                                    <div class="col-8 col-md-8 mb-2 offset-md-1">
                                                        <div class="row d-flex justify-content-between ">
                                                            <div class="col-6"><h6>Order Status</h6></div>
                                                            <div class="col-3"><h6>Mail</h6></div>
                                                            <div class="col-3"><h6>Mobile</h6></div>
                                                        </div>
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary" :disabled="isLoading">
                                            Save <b-spinner v-if="isLoading" small label="Spinning"></b-spinner>
                                        </button>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="mt-5">
                                                <div class="form-group">
                                                     ...
                                                     <input type='text' id='username' v-model="settings.username" class='form-control' placeholder='Username' required />
                                                </div>
                                                <div class="form-group">
                                                    <label for='current_password'>Current Password</label>
                                                    <input type='password' id='current_password' v-model="settings.current_password" class='form-control' placeholder='Current Password' required />
                                                </div>
                                                <div class="form-group">
                                                    <label for='password'>Password</label>
                                                    <input type='password' id='password' v-model="settings.password" class='form-control' placeholder='Password' required />
                                                </div>
                                                <div class="form-group">
                                                    <label for='confirm_password'>Confirm Password</label>
                                                    <input type='password' id='confirm_password' v-model="settings.confirm_password" class='form-control' placeholder='Confirm Password' required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
