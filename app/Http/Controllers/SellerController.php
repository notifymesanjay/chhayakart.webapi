...
class SellerController extends BaseController
{
    ...
    public function getProducts(Request $request){
        ...
        s.name as seller_name, p.indicator, p.manufacturer, p.made_in, p.return_status, p.cancelable_status, p.till_status, osl.status as till_status_name ,p.description,p.features,
        pv.id as product_variant_id, pv.price, pv.discounted_price, pv.delivery_charges,pv.taxes,pv.measurement, pv.status as pv_status , pv.stock,pv.stock_unit_id, u.short_code,
    ...
    public function getReturnRequests(){
        ...
        $ReturnRequests = ReturnRequest::select('return_requests.*','users.name',
            ...
            'order_items.discounted_price','product_variants.delivery_charges','product_variants.taxes','order_items.product_name','order_items.variant_name')
