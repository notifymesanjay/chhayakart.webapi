...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::group(['prefix' => 'web_header'], function () {
        Route::get('/', [\App\Http\Controllers\API\WebHeaderApiController::class, 'index']);
        Route::post('save', [\App\Http\Controllers\API\WebHeaderApiController::class, 'save']);
    });
    ...
    Route::group(['prefix' => 'withdrawal_requests'], function () {
        ...
        Route::post('save', [\App\Http\Controllers\API\WithdrawalRequestsApiController::class, 'save']);
