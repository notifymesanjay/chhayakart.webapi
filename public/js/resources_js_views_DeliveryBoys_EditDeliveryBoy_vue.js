  ...
  methods: {
    ...
    getCities: function getCities() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/cities').then(function (response) {
        ...
        if (_this.deliveryBoys.id && (_this$record = _this.record) !== null && _this$record !== void 0 && _this$record.city_id) {
    ...
    getDeliveryBoy: function getDeliveryBoy() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/delivery_boys/edit/' + this.id).then(function (response) {
        ...
        if (data.status === 1) {
          ...
          _this2.deliveryBoys.id = _this2.record ? _this2.record.id : null;
          _this2.deliveryBoys.admin_id = _this2.record ? _this2.record.admin_id : "";
          _this2.deliveryBoys.name = _this2.record ? _this2.record.name : "";
          _this2.deliveryBoys.dob = _this2.record ? _this2.record.dob : "";
          _this2.deliveryBoys.mobile = _this2.record ? _this2.record.mobile : "";
          _this2.deliveryBoys.email = _this2.record ? _this2.record.admin.email : "";
          _this2.deliveryBoys.password = "";
          _this2.deliveryBoys.confirm_password = "";
          _this2.deliveryBoys.bonus = _this2.record ? _this2.record.bonus : "";
          _this2.deliveryBoys.ifsc_code = _this2.record ? _this2.record.ifsc_code : "";
          _this2.deliveryBoys.bank_name = _this2.record ? _this2.record.bank_name : "";
          _this2.deliveryBoys.bank_account_number = _this2.record ? _this2.record.bank_account_number : "";
          _this2.deliveryBoys.account_name = _this2.record ? _this2.record.account_name : "";
          _this2.city = _this2.cities.filter(function (item) {
            return item.id === _this2.record.city_id;
          });
          _this2.deliveryBoys.city_id = _this2.record ? _this2.record.city_id : "";
          _this2.deliveryBoys.address = _this2.record ? _this2.record.address : "";
          _this2.deliveryBoys.other_payment_information = _this2.record ? _this2.record.other_payment_information : "";
          _this2.deliveryBoys.driving_license = "";
          _this2.deliveryBoys.driving_license_url = _this2.record ? _this2.$storageUrl + _this2.record.driving_license : "";
          _this2.deliveryBoys.national_identity_card = "";
          _this2.deliveryBoys.national_identity_card_url = _this2.record ? _this2.$storageUrl + _this2.record.national_identity_card : "";
          _this2.deliveryBoys.status = _this2.record ? _this2.record.status : 0;
          _this2.deliveryBoys.remark = _this2.record ? _this2.record.remark : "";
        } else {
    ...
    saveRecord: function saveRecord() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post(url, formData, {
        ...
        if (data.status === 1) {
          ...
          _this3.$eventBus.$emit('deliveryBoysSaved', data.message);
        } else {
        ...
        if ((_error$request2 = error.request) !== null && _error$request2 !== void 0 && _error$request2.statusText) {
          ...
          _this3.showError((_error$request3 = error.request) === null || _error$request3 === void 0 ? void 0 : _error$request3.statusText);
        } else if (error.message) {
